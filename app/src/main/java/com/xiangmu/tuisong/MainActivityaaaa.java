...
public class MainActivityaaaa extends InstrumentedActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(MainActivityaaaa.this, PushSetActivity.class);
